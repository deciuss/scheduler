 ...
 */
final class Version20210417145944 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student_group_intersection (id INT AUTO_INCREMENT NOT NULL, group_intersecting_id INT NOT NULL, group_intersected_id INT NOT NULL, INDEX IDX_89D7FA38D791D15 (group_intersecting_id), INDEX IDX_89D7FA386C850F4D (group_intersected_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subject (id INT AUTO_INCREMENT NOT NULL, teacher_id INT NOT NULL, student_group_id INT NOT NULL, hours INT NOT NULL, block_size SMALLINT NOT NULL, INDEX IDX_FBCE3E7A41807E1D (teacher_id), INDEX IDX_FBCE3E7A4DDF95DC (student_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE student_group_intersection ADD CONSTRAINT FK_89D7FA38D791D15 FOREIGN KEY (group_intersecting_id) REFERENCES student_group (id)');
        $this->addSql('ALTER TABLE student_group_intersection ADD CONSTRAINT FK_89D7FA386C850F4D FOREIGN KEY (group_intersected_id) REFERENCES student_group (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student_group_intersection DROP FOREIGN KEY FK_89D7FA38D791D15');
        $this->addSql('ALTER TABLE student_group_intersection DROP FOREIGN KEY FK_89D7FA386C850F4D');
